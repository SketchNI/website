...
/*
 * This file is derived of the league/commonmark package.
 *
...
class SketchMark implements ConfigurableExtensionInterface
{
    public function configureSchema(ConfigurationBuilderInterface $builder): void
    {
        $builder->addSchema('commonmark', Expect::structure([
            ...
            'unordered_list_markers' => Expect::listOf('string')->min(1)->default([
                '*', '+', '-',
            ])->mergeDefaults(false),
        ]));
    }
    ...
    public function register(EnvironmentBuilderInterface $environment): void
    {
        $environment
            ...
            ->addRenderer(Node\Inline\Link::class, new Renderer\Inline\LinkRenderer())
